...
<body>
    <div class="container">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Mostrar Área Rural</li>
        </ol>
        <!-- Content Row -->
        <div class="row">
            <div class="container">
            ...
            <div class="dados">
                ...
                <div class="dados-mais">
                    @if ($imovel->energia!=="t")<p  class="nao-mostra"><i class="far fa-check-square green"></i> Energia Elétrica</p> @else <p><i class="far fa-check-square green"></i>&nbsp;&nbsp; Energia Elétrica </p> @endif
                    @if ($imovel->cerca!=="t")<p  class="nao-mostra"><i class="far fa-check-square green"></i> Cercado </p> @else <p><i class="far fa-check-square green"></i>&nbsp;&nbsp; Cercado</p> @endif</div>
            </div>
