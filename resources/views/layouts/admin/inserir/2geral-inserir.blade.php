<div class="control-group form-group row">
    <div class="controls col-md-6">
        ...
        <textarea class="form-control" id="obs" required="" name="obs" rows="4" placeholder="Observações do Imóvel" required></textarea>
    </div>
    <div class="controls col-md-6">
        <label for="obs" class="form-label">Notas:</label><br>
        <textarea class="form-control" id="obs" required="" name="notas" rows="4" placeholder="Notas da Venda"></textarea>
    </div>
</div>
<div class="control-group form-group row">
    <div class="controls col-md-6">
        <label for="img" class="form-label">Imagens: <span style="color:gray;">(a última imagem será o destaque)<span></label><br>
            <div class="custom-file">
                <input type="file" class="custom-file-input" id="img" required="" name="img[]" multiple required>
