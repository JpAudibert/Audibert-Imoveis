<div class="control-group form-group row">
    <div class="controls col-md-6">
        ...
        <textarea class="form-control" id="obs" name="obs" rows="4" placeholder="Descrição do Imóvel" required></textarea>
    </div>
    <div class="controls col-md-6">
    ...
    <div class="control-group form-group row">
        <div class="controls col-md-6">
            ...
            <textarea class="form-control" id="obs" name="notas" rows="4" placeholder="Observações da Venda"></textarea>
        </div>
        <div class="controls col-md-6">
