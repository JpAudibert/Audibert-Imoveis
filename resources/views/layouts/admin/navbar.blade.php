        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownInserir">
                        <a class="dropdown-item" href="{{url('/apartamento/visualizar')}}">Apartamento</a>
                        <a class="dropdown-item" href="{{url('/casa/visualizar')}}">Casa</a>
                        <a class="dropdown-item" href="{{url('/terreno/visualizar')}}">Terreno</a>
                        <a class="dropdown-item" href="{{url('/rural/visualizar')}}">Área Rural</a>
                        <a class="dropdown-item" href="{{url('/comercial/visualizar')}}">Salas/Pavilhões</a>
                        <a class="dropdown-item" href="{{url('/visualizar')}}">Ver todos</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
