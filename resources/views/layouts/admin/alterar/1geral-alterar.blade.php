              ...
              <div class="container">
                ...
                <div class="control-group form-group row">
                  <div class="controls col-md-6">
                    ...
                    <input type="text" class="form-control" id="valor" name="valor" value="{{$imovel->valor}}" required data-validation-required-message="Insira o Valor" placeholder="Valor do Imóvel" onkeypress="if (!isNaN(String.fromCharCode(window.event.keyCode))) return true; else return false;">
                  </div>
                  <div class="controls col-md-6">
